...
description: Use when performing systematic debugging work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# systematic debugging with PCO

## Overview
Use this skill to apply PCO operating loop to systematic debugging work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches systematic debugging workflow.
