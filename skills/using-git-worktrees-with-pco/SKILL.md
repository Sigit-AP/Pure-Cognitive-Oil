---
name: using-git-worktrees-with-pco
description: Use when performing using git worktrees work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# using git worktrees with PCO

## Overview
Use this skill to apply PCO operating loop to using git worktrees work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches using git worktrees workflow.
