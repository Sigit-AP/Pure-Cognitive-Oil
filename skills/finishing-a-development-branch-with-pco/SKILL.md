---
name: finishing-a-development-branch-with-pco
description: Use when performing finishing a development branch work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# finishing a development branch with PCO

## Overview
Use this skill to apply PCO operating loop to finishing a development branch work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches finishing a development branch workflow.
