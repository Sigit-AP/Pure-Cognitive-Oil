---
name: executing-plans-with-pco
description: Use when performing executing plans work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# executing plans with PCO

## Overview
Use this skill to apply PCO operating loop to executing plans work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches executing plans workflow.
