---
name: writing-plans-with-pco
description: Use when performing writing plans work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# writing plans with PCO

## Overview
Use this skill to apply PCO operating loop to writing plans work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches writing plans workflow.
