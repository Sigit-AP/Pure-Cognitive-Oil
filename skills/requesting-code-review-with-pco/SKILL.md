---
name: requesting-code-review-with-pco
description: Use when performing requesting code review work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# requesting code review with PCO

## Overview
Use this skill to apply PCO operating loop to requesting code review work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches requesting code review workflow.
