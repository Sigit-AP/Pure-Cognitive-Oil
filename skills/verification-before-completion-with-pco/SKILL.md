---
name: verification-before-completion-with-pco
description: Use when performing verification before completion work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# verification before completion with PCO

## Overview
Use this skill to apply PCO operating loop to verification before completion work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches verification before completion workflow.
