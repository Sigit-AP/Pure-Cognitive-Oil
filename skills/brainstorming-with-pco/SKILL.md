---
name: brainstorming-with-pco
description: Use when performing brainstorming work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# brainstorming with PCO

## Overview
Use this skill to apply PCO operating loop to brainstorming work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches brainstorming workflow.
