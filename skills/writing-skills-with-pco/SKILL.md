---
name: writing-skills-with-pco
description: Use when performing writing skills work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# writing skills with PCO

## Overview
Use this skill to apply PCO operating loop to writing skills work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches writing skills workflow.
