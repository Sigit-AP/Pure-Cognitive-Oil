---
name: receiving-code-review-with-pco
description: Use when performing receiving code review work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# receiving code review with PCO

## Overview
Use this skill to apply PCO operating loop to receiving code review work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches receiving code review workflow.
