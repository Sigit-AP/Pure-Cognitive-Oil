---
name: dispatching-parallel-agents-with-pco
description: Use when performing dispatching parallel agents work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# dispatching parallel agents with PCO

## Overview
Use this skill to apply PCO operating loop to dispatching parallel agents work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches dispatching parallel agents workflow.
