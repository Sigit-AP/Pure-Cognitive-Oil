---
name: refactoring-with-pco
description: Use when performing refactoring work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# refactoring with PCO

## Overview
Use this skill to apply PCO operating loop to refactoring work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches refactoring workflow.
