---
name: test-driven-development-with-pco
description: Use when performing test driven development work with PCO routing, bounded context, evidence gates, and honest completion language.
---

# test driven development with PCO

## Overview
Use this skill to apply PCO operating loop to test driven development work: understand, route, load bounded context, plan, execute, verify, audit, and finalize.

## When to Use
- Task matches test driven development workflow.
